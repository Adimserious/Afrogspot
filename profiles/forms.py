...
class ProfileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'default_full_name': forms.TextInput(attrs={'class':
                                                        'form-control'}),
            'default_email': forms.EmailInput(attrs={'class': 'form-control'}),
            'default_phone_number': forms.TextInput(attrs={'class':
                                                           'form-control'}),
            'default_address_line_1': forms.TextInput(attrs={'class':
                                                             'form-control'}),
            'default_address_line_2': forms.TextInput(attrs={'class':
                                                             'form-control',
                                                             'placeholder':
                                                             'Optional'}),
            'default_city': forms.TextInput(attrs={'class':
                                                   'form-control'}),
            'default_postal_code': forms.TextInput(attrs={'class':
                                                          'form-control'}),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name in self.fields:
            if field_name in [
                'default_full_name', 'default_email', 'default_phone_number',
                'default_address_line_1', 'default_city',
